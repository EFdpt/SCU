...
\begin{center}
\leavevmode
\includegraphics[width=140pt]{_c_o__can_8h__incl}
\end{center}
\end{figure}
...
\begin{DoxyCompactList}\small\item\em This function send a C\+A\+Nopen message over C\+AN servizi network. \end{DoxyCompactList}\end{DoxyCompactItemize}
