...
\Hypertarget{_c_a_n_network_page_NODE-ID}%
N\+O\+DE  }&\textbf{ N\+O\+D\+E-\/\+ID   }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\Hypertarget{_c_a_n_network_page_TPDO_Timer}%
...
\rowcolor{\tableheadbgcolor}\textbf{ TX N\+O\+DE  }&\textbf{ Data  }&\textbf{ Unit  }&\textbf{ Data Length  }&\textbf{ Data Offset  }&\textbf{ \#\+C\+AN packet  }&\textbf{ ID  }&\textbf{ Total Length   }\\\cline{1-8}
\endhead
\multirow{9}{\linewidth}{$SCU_{FRONT}$  }&First A\+P\+PS  &$\%$  &$1\ Byte$  &$[0:7]$  &\multirow{5}{\linewidth}{\#1  }&\multirow{5}{\linewidth}{T\+P\+D\+O1 + N\+O\+D\+E-\/\+ID  }&\multirow{5}{\linewidth}{4   }\\\cline{2-5}
